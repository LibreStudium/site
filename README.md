# LibreStudium — предрелизная страница

Временная landing-страница веб-портала ИТ-экосистемы LibreStudium. Показывает экран «скоро откроется» до запуска полноценного портала.
